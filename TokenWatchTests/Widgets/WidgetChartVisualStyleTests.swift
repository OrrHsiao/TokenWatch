...
struct WidgetChartVisualStyleTests {
    ...
    func constantsMatchPopover() {
        ...
        #expect(WidgetChartVisualStyle.heatmapTileBorderWidth == 0.5)
        #expect(WidgetChartVisualStyle.heatmapTileBorderDarkOpacity == 0.08)
    ...
    func layoutAndZeroScaleAreStable() {
        ...
        #expect(WidgetChartVisualStyle.heatmapTileSide(availableWidth: 305, availableHeight: 96) == 11)
