    ...
    func directoryAuthorizationStringsCoverMigratedLanguages() {
        ...
        let expected: [AppLanguage: [String]] = [
            ...
            .nl: [
                ...
                "Niet geautoriseerd",
                "Geautoriseerd",
                "Kies de gegevensmap van Claude Code. Deze moet rechtstreeks de map \"projects\" bevatten. Voer \"printenv CLAUDE_CONFIG_DIR\" uit in de Terminal om een geconfigureerde locatie te controleren. Als er niets wordt weergegeven, zoek dan naar een map met de naam \".claude\".",
                "Kies de gegevensmap van Codex. Deze moet rechtstreeks de map \"sessions\" of \"archived_sessions\" bevatten. Voer \"printenv CODEX_HOME\" uit in de Terminal om een geconfigureerde locatie te controleren. Als er niets wordt weergegeven, zoek dan naar een map met de naam \".codex\".",
                "Kies de gegevensmap van opencode. Deze moet rechtstreeks \"opencode.db\" bevatten. Als je deze niet kunt vinden, voer dan \"opencode db path\" uit in de Terminal en kies de map die het weergegeven bestand bevat.",
                "Kiezen",
